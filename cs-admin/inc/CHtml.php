...
class CHtml
{
	...
	{
		return htmlspecialchars($text,ENT_QUOTES,cs_var('charset'));
	}
	...
	public static function encodeArray($data)
	{
		...
		{
			if(is_string($key))
				$key=htmlspecialchars($key,ENT_QUOTES,cs_var('charset'));
			if(is_string($value))
				$value=htmlspecialchars($value,ENT_QUOTES,cs_var('charset'));
